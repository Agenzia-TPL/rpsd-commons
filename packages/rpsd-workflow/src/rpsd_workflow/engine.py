...
class WorkflowEngine:
    ...
    def workflow(self, name: str = None, domain: str = None, description: str = None, version: str = None):
        def decorator(func):
            workflow_domain = domain or self._extract_domain_from_module(func.__module__)
    ...
    def activity(self, name: str = None, domain: str = None, description: str = None):
        def decorator(func):
            activity_domain = domain or self._extract_domain_from_module(func.__module__)
    ...
    def _discover_from_installed_packages(self):
        ...
        for package in pkg_resources.working_set:
            ...
            if package_name.startswith('workflows-') or package_name.endswith('-workflows'):
                try:
